...
function view(dispatch, model) {
  return div({ className: "flex flex-col gap-4 items-center" }, [
    ...
    p({ className: "text-2xl" }, `count: ${model.count}`),
    button({ className: btnStyle, onclick: () => dispatch(MSGS.INCREASE) }, "Increase by 1"),
    button({ className: btnStyle, onclick: () => dispatch(MSGS.DECREASE) }, "Decrease by 1"),
